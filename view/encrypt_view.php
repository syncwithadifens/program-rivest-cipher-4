  ...
  <main>
    <form action="" method="post">
      <fieldset>
        ...
        <textarea id="input-text" name="plaintext" rows="10" cols="60" placeholder="Enter your message to encrypted here"><?= $plaintext ?></textarea>
      </fieldset>
      <fieldset>
        <legend>Key</legend>
    ...
    <div id="result-area">
      ...
      <pre><code class="language-html"><?php echo ($encodedCipher != '' ? $encodedCipher : 'No text encrypted'); ?></code></pre>
    </div>
  </main>
